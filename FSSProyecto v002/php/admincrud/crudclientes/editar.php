...
if(isset ($_POST['update']) ) 
{
    ...
    echo'<script type="text/javascript"> alert("Cliente editado correctamente"); window.location.href="adminclientes.php";
    </script>';
    }
            ...
            <div class="contact-form">
                <form name="forml" method= "post" action="editar.php">
                    ...
                    <p>
                        ...
                        <input type="text" name="Tel_contacto" value="<?php echo $Tel_contacto;?>" autocomplete="off">
                    </p>
                    <p>
