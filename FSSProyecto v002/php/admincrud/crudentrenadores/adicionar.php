...
if(isset ($_POST['Submit']) ){
    ...
    $sql = "INSERT INTO entrenador(Doc_identidad, Tipo_doc, Nombres, Apellidos, Tel_contacto, Cel_contacto, Email) 
    ...
    echo'<script type="text/javascript"> alert("Entrenador agregado"); window.location.href="adminentrenadores.php";
    </script>';
    }
?>
</body>
